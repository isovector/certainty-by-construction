...
\newcommand{\BookEnv}[3]{\newenvironment{#1}{\begin{tcolorbox}[breakable, left=2.5mm, right=3mm, top=4mm, bottom=0mm, skin=enhancedmiddle, colframe=white, title={\color{black}#2\quad{}\impact{#3}}]\color{black}}{\end{tcolorbox}}}
