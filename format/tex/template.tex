...
$endif$
\usepackage{xcolor}
\usepackage[paperwidth=6.25in,paperheight=9.25in,inner=0.75in, outer=1.5cm, top=2cm, bottom=2cm]{geometry}
$if(listings)$
\usepackage{listings}
...
% \newenvironment{AgdaInfo}{\smallskip\begin{bclogo}[arrondi=0.5,logo={\LARGE\Info},barre=none,tailleOndu=1.5,noborder=true,couleurBarre=gray]{\impact{Info Window}}}{\end{bclogo}}

\newenvironment{AgdaInfo}{\begin{tcolorbox}[breakable, left=2.5mm, right=3mm, top=4mm, bottom=0mm,
skin=enhancedmiddle, colframe=white, title={\color{black}\Info\quad{}\impact{INFO WINDOW}}]\color{black}}{\end{tcolorbox}}


\newfontfamily{\impact}{SofiaSansCondensed-Medium}

\pagestyle{fancy}
\setlength{\headheight}{15.71pt}
...
{\small who knows much about equality}
\end{center}
\vfill
\vfill
\vfill
...
\settowidth\longest{\Large The first principle is that you must not fool yourself,}
\bigQuote{Richard Feynman}{
