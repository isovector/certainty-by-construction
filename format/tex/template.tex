...
\newenvironment{AgdaInfo}{\vquad\begin{bclogo}[arrondi=0.5,logo=\bcloupe,barre=snake,tailleOndu=1.5,noborder=true,couleurBarre=gray]{\quad Response}}{\end{bclogo}}
